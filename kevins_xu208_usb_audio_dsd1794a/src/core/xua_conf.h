...
/* 明确告诉 XMOS 编译器：你板子上的晶振物理频率是 45M 和 49M */
#ifndef MCLK_441
...
#define PID_AUDIO_2 (0x880D) /* SKC_SU1 USB Audio Reference Design PID */
#define PID_AUDIO_1 (0x880D) /* SKC_SU1 Audio Reference Design PID */
#define PRODUCT_STR_A2 "Kevin's Hi-Fi Audio (UAC2.0)"
#define PRODUCT_STR_A1 "Kevin's Hi-Fi Audio (UAC1.0)"
